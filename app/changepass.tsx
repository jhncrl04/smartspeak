        ...
        <ThemedView style={styles.container}>
                    ...
                    <View style={styles.ParentInformationContainer}>
                        <View style={styles.ParentInformation}>
                            ...
                            <TextInput 
                                ...
                                placeholderTextColor={isEditing ? "#434343" : "rgba(67, 67, 67, 0.7)"}
                            />
                        </View>
            ...
            <View style={styles.footer}>
                <View style={styles.categoryContainer}>
                    <TouchableOpacity style={styles.categoryInfos} onPress={() => router.push('/profile')}>
                    ...
                    <TouchableOpacity style={styles.categoryInfosActive} onPress={() => router.push('/changepass')}>
